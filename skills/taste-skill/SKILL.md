...
| Ant Design / Chinese enterprise admin / Feishu-adjacent React tools | `antd` + `@ant-design/icons` | Official Ant Design components, tokens, compact data-entry patterns |
